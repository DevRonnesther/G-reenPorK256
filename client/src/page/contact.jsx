...
const Contact = () => {
  ...
  const inputBase =
    "w-full px-5 py-4 rounded-2xl bg-[#F8FAFC] focus:bg-white text-[#1F2937] outline-none border border-[#E5E7EB]/70 focus:border-red-600 focus:ring-4 focus:ring-red-600/10 placeholder:text-[#1F2937]/40 text-sm font-medium transition-all duration-200";
    ...
    <div className="min-h-screen bg-white text-[#1F2937] overflow-hidden relative">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-12 space-y-8">
            ...
            <div className="space-y-3">
              <InfoRow
                ...
                iconBg="bg-yellow-400/10" iconColor="text-yellow-600"
                label="Phone" value={PHONE_DISPLAY}
                href={`tel:${WHATSAPP_NUMBER}`}
              />
              <InfoRow
                icon={<Mail size={16} aria-hidden="true" />}
                iconBg="bg-red-600/10" iconColor="text-red-600"
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <a
                    ...
                    className="w-11 h-11 rounded-xl bg-[#F8FAFC] border border-[#E5E7EB]/40 hover:bg-red-600/10 text-[#1F2937]/60 hover:text-red-600 flex items-center justify-center transition-all duration-200"
                  >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
              ...
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className={`${inputBase} ${errors.firstName ? "bg-red-600/5 border-red-600/50 focus:ring-red-600/20 focus:border-red-600" : ""}`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`${inputBase} ${errors.lastName ? "bg-red-600/5 border-red-600/50 focus:ring-red-600/20 focus:border-red-600" : ""}`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`${inputBase} ${errors.email ? "bg-red-600/5 border-red-600/50 focus:ring-red-600/20 focus:border-red-600" : ""}`}
                  {...register("email", {
                    required: "Required",
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`${inputBase} resize-none ${errors.message ? "bg-red-600/5 border-red-600/50 focus:ring-red-600/20 focus:border-red-600" : ""}`}
                  {...register("message", {
                    required: "Required",
                    minLength: { value: 10, message: "At least 10 characters" },
                  })}
                />
                {errors.message && <p className="mt-1.5 text-xs text-red-600 font-semibold">{errors.message.message}</p>}
              </div>
              ...
              <button
                ...
                className="group inline-flex items-center justify-center gap-3 bg-red-600 hover:bg-red-600/90 disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold px-8 py-4 rounded-2xl shadow-xl hover:scale-[1.01] transition-all duration-200 shadow-red-600/20 w-full sm:w-auto"
              >
      ...
      <footer className="py-10 px-6 bg-white relative z-10 border-t border-[#E5E7EB]/40">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <Link to="/returnPolicy" className="text-xs font-bold text-red-600 hover:text-red-600/80 transition-colors">
            Return Policy
          </Link>
        </div>
      </footer>
