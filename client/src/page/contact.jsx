    ...
    <div className="min-h-screen bg-white text-[#1F2937] overflow-hidden relative">
          ...
          <div className="lg:col-span-7 bg-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-[#E5E7EB]/50 border border-[#E5E7EB]/30">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
              ...
              <button
                ...
                className="group inline-flex items-center justify-center gap-3 bg-[#0edb0e] hover:bg-[#0bc50b] disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold px-8 py-4 rounded-2xl shadow-xl hover:scale-[1.01] transition-all duration-200 shadow-[#0edb0e]/20 w-full sm:w-auto"
              >
      ...
      <footer className="py-10 px-6 bg-white relative z-10 border-t border-[#E5E7EB]/40">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <Link to="/returnPolicy" className="text-xs font-bold text-[#0edb0e] hover:text-[#0bc50b] transition-colors">
            Return Policy
          </Link>
        </div>
      </footer>
